...
#' Launch the SqlCon Developer Shiny app
#' 
...
#' 
#' @export
launchSQLConDeveloper <- function(launch.browser = TRUE) {
  ensure_installed("shinydashboard")
  appDir <- system.file("shinyApps", "SqlDeveloper", package = "SQLCon")
  shiny::runApp(appDir, display.mode = "normal", launch.browser = launch.browser)
  print("afaf in launcher ")
