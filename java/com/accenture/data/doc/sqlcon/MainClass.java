...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		for (int i = 2; i < args.length - 1; i++)
			if (args[i].equals("-convert")) {
				String targetDialect = args[i + 1];
				String sourceDialect = args[i + 2];
				sql = SqlConvert.convertSqlWithPath(sql, targetDialect, sourceDialect, sessionId, oracleTempSchema, "");
			}
	...
	private static void printUsage() {
		...
		System.out.println("  Translates SQL into one of the supported target SQL dialects, and renders the SQL according to user-specified parameters. See https://github.com/ for details.");
		System.out.println("");
